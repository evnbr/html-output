(function(mod) {
  ...
  function makeMarker(array, linesFree, labels, severity, multiple, tooltips) {
  ...
  function annotationTooltip(ann, index) {
    var severity = ann.severity;
    if (!SEVERITIES.test(severity)) severity = "error";
    var tip = document.createElement("div");
    tip.className = "CodeMirror-lint-message-" + severity;
    tip.id = get_id_from(ann);
    // console.log(tip);
  ...
  function popupSpanTooltip(ann, e) {
    ...
    function hide() {
      ...
      el.classList.remove("CM-current-lint");
    }
  ...
  function get_id_from(ann) {
    return "CMLint-line" + ann.from.line + "num" + ann.from.ch;
  }
